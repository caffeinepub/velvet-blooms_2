...
export class Backend implements backendInterface {
    ...
    async updateProductDescription(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProductDescription(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyPasskey(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyPasskey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
